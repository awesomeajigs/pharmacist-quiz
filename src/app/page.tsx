...
export default function HomePage() {
  return (
    <main className="relative flex flex-1 flex-col overflow-hidden bg-white px-6 pb-8 pt-12 short:pb-6 short:pt-8">
      <div className="relative z-10 flex flex-col gap-4 short:gap-3">
        <p className="text-[11px] font-medium tracking-[0.08em] text-accent">
          WORLD PHARMACIST DAY · SEPT 25
        </p>
        <h1 className="text-[clamp(28px,8.6vw,32px)] font-bold leading-[1.08] tracking-[-0.01em] text-ink">
